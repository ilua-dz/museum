...
console.log('P.S. Уважаемый проверяющий, на веб-странице реализованы функции случайного размещения изображений в галерее, калькулятора стоимости билетов. Прошу не снимать баллы за частичное несоответствие верстке в секции галереи (за отличное от макета размещение изображений) и в секции Tickets/форме покупки билетов (за отличные от макета цифры).')
