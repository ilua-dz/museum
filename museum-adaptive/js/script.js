...
console.log('Предварительная оценка - 142 балла')
...
console.log('-3 При плавном масштабировании полоса прокрутки не появляется, но обрезаются некоторые элементы в footer')
