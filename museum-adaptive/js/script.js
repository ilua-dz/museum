...
console.log('Предварительная оценка - 141 балл')
console.log('Не выполненные/частично выполненные пункты:')
console.log('-6 На разрешении 420px не полностью выполнена верстка footer и формы покупки билетов;')
console.log('-3 При масштабировании иногда появляется горизонтальная полоса прокрутки;')
console.log('-1 Для слайдера в Welcome не во всех разрешениях выполнена респонсивная верстка;')
...
console.log('PS. Уважаемый проверяющий, я постараюсь исправить недочеты в ближайшие 48 часов, прошу не торопиться с оценкой.')
